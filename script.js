...
accordionItem.forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        item.querySelector('.icon-plus').classList.toggle('active');
        item.querySelector('.icon-minus').classList.toggle('active');
        item.querySelector('.accordion--item--detail').classList.toggle('active');
